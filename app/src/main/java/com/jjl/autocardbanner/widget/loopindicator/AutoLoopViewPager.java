 ...
 * changes in the adapter must be done. The adapter must be prepared to create banner2
 * extra items e.g.:
 * 
 * The original adapter creates 4 items: [0,banner1,banner2,banner3] The modified adapter will
 * have to create 6 items [0,banner1,banner2,banner3,4,5] with mapping
 * realPosition=(position-banner1)%count [0->banner3, banner1->0, banner2->banner1, banner3->banner2, 4->banner3, 5->0]
 */
public class AutoLoopViewPager extends ViewPager {
	...
	/** scroll factor for auto scroll animation, default is banner1.0 **/
	private double autoScrollFactor = 1.0;
	/** scroll factor for swipe scroll animation, default is banner1.0 **/

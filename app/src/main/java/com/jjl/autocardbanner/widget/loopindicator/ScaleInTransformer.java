...
{
    private static final float DEFAULT_MIN_SCALE = 0.74f;
    ...
    public void pageTransform(View view, float position)
    {
        ...
        { // [-banner1,banner1]
            ...
            if (position < 0) //banner1-banner2:banner1[0,-banner1] ;banner2-banner1:banner1[-banner1,0]
            {
            ...
            } else //banner1-banner2:banner2[banner1,0] ;banner2-banner1:banner2[0,banner1]
            {
                float scaleFactor = (1 - position) * (1 - mMinScale) + mMinScale;
                view.setScaleX(scaleFactor);
                view.setScaleY(scaleFactor);
